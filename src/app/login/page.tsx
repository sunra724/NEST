    ...
    <div className="flex min-h-screen items-center justify-center bg-slate-50 p-4">
      <div className="w-full max-w-sm rounded-2xl bg-white p-10 shadow-lg">
        <div className="mb-8 flex flex-col items-center gap-3">
          ...
          <p className="text-center text-sm text-slate-500">청년 N.E.S.T. 성과관리 대시보드</p>
        </div>
        ...
        <p className="mt-6 text-center text-xs text-slate-400">.env.local의 ADMIN_PASSWORD로 로그인합니다</p>
      </div>
    </div>
  );
}
